      ...
      >
        <div class="boxs j-b flex a-c">
          <div class="a-c j-c flex">
            ...
            <!--标题-->
            <div class="text2" @click="click5(item,index)">{{item.title}}</div>
          </div>
          ...
          <div v-else>
            ...
            <div v-else>{{item.hour}}小时前</div>
            <!--<div v-if="item.hour && item.hour<24 && item.mins>60">{{item.hour}}小时前</div>-->
          </div>
          <!--<div v-if="item.mins&&item.mins<60">{{item.mins}}分钟前</div>-->
        </div>
      </div>
